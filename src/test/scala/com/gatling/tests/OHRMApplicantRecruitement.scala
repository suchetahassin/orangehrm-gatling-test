...
class OHRMApplicantRecruitement extends Simulation {
	...
	val scn = scenario("OHRMApplicantRecruitement")
		.exec(http("request_0")
		...
		.exec(http("request_14")
			...
			.headers(headers_14)
			.formParam("_token", "b.gHjEomkS5X0GXtp9UGFYwlpFA-ZlS2BMJLVvdkyjGlA.wwKjzjFErzpgPIlMMxtqrRwPdqAVCgYFaoYcFDaSIgXDTZLIDlyfLG8O4g")
			...
			.headers(headers_29),
            http("request_30")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/dashboard/employees/time-at-work?timezoneOffset=6&currentDate=2023-09-09&currentTime=20:06")
			.headers(headers_30),
            http("request_31")
		...
		.exec(http("request_62")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/recruitment/addCandidate/1")
			.headers(headers_38)
			...
			.headers(headers_52),
            http("request_77")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/recruitment/candidates/1")
			.headers(headers_33),
            http("request_78")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/leave/holidays?fromDate=2023-01-01&toDate=2023-12-31")
			.headers(headers_33),
			...
			.headers(headers_33),
            http("request_81")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/recruitment/candidates/1/actions/allowed")
			.headers(headers_33),
            http("request_82")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/recruitment/candidates/1/history?limit=50&offset=0")
			.headers(headers_30),
            http("request_83")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/recruitment/candidate/1/attachment")
			.headers(headers_33)))
		.pause(1)
		.exec(http("request_84")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/recruitment/changeCandidateVacancyStatus?candidateId=1&selectedAction=2")
			.headers(headers_38)
		...
		.exec(http("request_100")
			.put("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/recruitment/candidates/1/shortlist")
			.headers(headers_100)
			.body(RawFileBody("com/gatling/tests/ohrmapplicantrecruitement/0100_request.json")))
		.pause(1)
		...
		.exec(http("request_123")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/recruitment/changeCandidateVacancyStatus?candidateId=1&selectedAction=4")
			.headers(headers_38)
		...
		.exec(http("request_142")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/recruitment/interviewers?nameOrId=Suche")
			.headers(headers_30))
		.pause(1)
		.exec(http("request_143")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/recruitment/interviewers?nameOrId=Sucheta")
			.headers(headers_30))
		.pause(1)
		.exec(http("request_144")
			.post("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/recruitment/candidates/1/shedule-interview")
			.headers(headers_144)
			.body(RawFileBody("com/gatling/tests/ohrmapplicantrecruitement/0144_request.json")))
		.pause(1)
		...
		.exec(http("request_167")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/recruitment/changeCandidateVacancyStatus?candidateId=1&selectedAction=5")
			.headers(headers_38)
		...
		.exec(http("request_183")
			.put("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/recruitment/candidates/1/interviews/1/pass")
			.headers(headers_100)
			.body(RawFileBody("com/gatling/tests/ohrmapplicantrecruitement/0183_request.json")))
		.pause(1)
		...
		.exec(http("request_206")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/recruitment/changeCandidateVacancyStatus?candidateId=1&selectedAction=7")
			.headers(headers_38)
		...
		.exec(http("request_222")
			.put("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/recruitment/candidates/1/job/offer")
			.headers(headers_100)
			.body(RawFileBody("com/gatling/tests/ohrmapplicantrecruitement/0222_request.json")))
		.pause(1)
		...
		.exec(http("request_245")
			.get("/orangehrm-5.5/orangehrm-5.5/web/index.php/recruitment/changeCandidateVacancyStatus?candidateId=1&selectedAction=9")
			.headers(headers_38)
			.resources(http("request_246")
			.get("/orangehrm-5.5/orangehrm-5.5/web/dist/js/chunk-vendors.js?v=1688731390829")
			.headers(headers_1),
            http("request_247")
			.get("/orangehrm-5.5/orangehrm-5.5/web/dist/js/app.js?v=1688731390829")
		...
		.exec(http("request_261")
			.put("/orangehrm-5.5/orangehrm-5.5/web/index.php/api/v2/recruitment/candidates/1/hire")
			.headers(headers_100)
			.body(RawFileBody("com/gatling/tests/ohrmapplicantrecruitement/0261_request.json")))
		.pause(1)
